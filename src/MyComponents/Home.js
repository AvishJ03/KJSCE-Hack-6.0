            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="image-block">
                  <img className="img-fluid phone-thumb" src={gif} alt="iphone-banner" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6 align-self-center text-center">
                <div className="image-block">
                  <img className="phone-thumb-md img-fluid" src={banner_img} alt="iphone-feature" />
                </div>
              </div>
                ...
                <div className="about-block">
                  <div className="about-item">
                    <div className="content">
                      ...
                      <p>The expert teacher explains and teaches topics in-depth ensuring conceptual clarity. The second teacher facilitates a class of 20 and pays attention to individual student’s needs making the sessions interactive and engaging</p>
                    </div>
                  </div>
                  <div className="about-item active">
                    <div className="content">
                      <h5>Structured to learn-practice-revise</h5>
                      <p>The expert teacher teaches concepts using strong visuals and storytelling. The second teacher solves doubts instantly, conducts tests and assigns homework</p>
                    </div>
                  </div>
                  <div className="about-item">
                    <div className="content">
                      <h5>Individual Knowledge Graph</h5>
                      <p>Every class is carefully designed by experts with methods that are proven to give results. Classes are structured to help students not just learn concepts but also practice and revise them</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-12">
                <div className="section-title">
                  ...
                  <p>VLearn is on a mission to nurture the future of the next generation and AI plays a major role in it</p>
                </div>
              </div>
            </div>
            <div className="row bg-elipse">
              <div className="col-lg-4 align-self-center text-center text-lg-right">
                <div className="feature-item">
                  <div className="content">
                    <h5>Homework</h5>
                    <p>Worksheets, class notes and practice through VLearn's - The Learning App</p>
                  </div>
                </div>
                <div className="feature-item">
                  <div className="content">
                    <h5>Testing</h5>
                    <p>Monthly subjective and objective tests covering the full syllabus and test discussions</p>
                  </div>
                </div>
              </div>
              <div className="col-lg-4 text-center">
                ...
                <div className="app-screen">
                  <img className="img-fluid" src={logo_concept} alt="app-screen" />
                </div>
                <div className="feature-item">
                  <div className="content">
              ...
              <div className="col-lg-4 text-center text-lg-left align-self-center">
                <div className="feature-item">
                  <div className="content">
                    <h5>Quizzes</h5>
                    <p>Tests, quizzes and worksheets for better practice and retention. </p>
                  </div>
                </div>
                <div className="feature-item">
                  <div className="content">
                    <h5>Visual Learning </h5>
                    <p>Learn from engaging & interactive video lessons on app</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <div className="counter-item">
                  <h3><span className="count" data-count="29">400</span>+</h3>
                  <p>Courses</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <div className="counter-item">
                  <h3><span className="count" data-count="200">2</span>k+</h3>
                  <p>Active Users</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <div className="counter-item">
                  <h3><span className="count" data-count="60">200</span>+</h3>
                  <p>Tutors</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
                <div className="counter-item">
                  <h3><span className="count" data-count="300">8</span>k+</h3>
          ...
          <div className="container">
            <div className="row bg-elipse-red">
              <div className="col-lg-4">
                <div className="image"><img className="phone-thumb" src={news} alt="iphone-app" /></div>
              </div>
              <div className="col-lg-8 align-self-center">
                <div className="content">
                  ...
                  <div className="description">
                    <p>Follow our socials and subscribe to our newsletter to stay updated and fetch every information in the world.</p>
                  </div>
                  <form action="#">
