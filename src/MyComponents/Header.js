      ...
      <div>
          <div className="nav-header">
            <div className="brand-logo">
                <a href="#">
                    <span className="logo-compact" onClick={handleclickhome}><img src={hori_logo} alt="" /></span>
                </a>
            </div>
        </div>
        <div className="header">    
            <div className="header-content clearfix">
                ...
                <div className="input-group icons">
                        ...
                        <button className='nav-btn' onClick={handleclickhome}>Home</button>
                        <button className='nav-btn' /* onClick={handleclickcourses} */>Courses</button>
                        <button className='nav-btn' onClick={handleclickquizlets}>Quizlets</button>
                        <button className='nav-btn' /* onClick={handleclickinterviews} */>Interviews</button>
                        <button className='nav-btn' /* onClick={handleclickcontests} */>Contests</button>
                    </div>
                </div>
                        ...
                        <li className="icons dropdown">
                            <div className="user-img c-pointer position-relative"   data-toggle="dropdown">
                                <span className="activity active"></span>
                                    <button onClick={handleclickprofile}><img src={avatar} height="40" width="40" alt="" /></button>
                            </div>
                        </li>
                    </ul>
                </div>
